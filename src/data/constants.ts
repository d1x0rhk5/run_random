...
export const Themes: Record<string, ColorTheme> = {
  ...
  pot: {
    background: '#071a13',
    marbleLightness: 63,
    marbleWinningBorder: '#f5d98f',
    skillColor: '#d9ff8f',
    coolTimeIndicator: '#f1b94d',
    entity: {
      box: {
        fill: '#2fd58d',
        outline: '#7cffcf',
    ...
    rankStroke: '#02110a',
    minimapBackground: '#0d2c1e',
    minimapViewport: '#f5d98f',
    winnerBackground: 'rgba(3, 19, 13, 0.82)',
    winnerOutline: '#062218',
    winnerText: '#f5d98f',
  },
};
